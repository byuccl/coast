...
static TaskHandle_t __NO_xMR semTasks[semtstNUM_TASKS];
...
void vStartSemaphoreTasks( unsigned portBASE_TYPE uxPriority ) __xMR {
...
void vEndSempahoreTasks() __NO_xMR {
	int i;
...
static void prvSemaphoreTest( void *pvParameters ) __xMR {
...
portBASE_TYPE xAreSemaphoreTasksStillRunning( void ) __xMR {
...
void vSemaphoreCountPrint( void ) __xMR {
...
void vSemaphoreCountClear( void ) __xMR {
